...
# Full desktop configuration with GUI apps
# Use this on YOUR personal laptops (sukkub, azazel)
# Imports maintainer.nix, so you get CLI tools + GUI
...
in {
  # Import CLI tools (you get everything from maintainer.nix)
  imports = [
    ./maintainer.nix
