# users/marcin/base/solaar.nix
#
# Solaar (Logitech device manager) configuration for marcin.
# Manages two devices:
#   - MX Keys S (keyboard)
#   - MX Master 3S (mouse)
#
# rules.yaml  — thumb-wheel zoom, gesture-button workspace switching
# config.yaml — per-device persistent settings (DPI, fn-swap, …)
{ ... }: {
